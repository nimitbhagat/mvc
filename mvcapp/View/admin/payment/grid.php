        ...
        <div class="card text-white bg-dark mb-12">
            <div class="card-body">
                ...
                <table class="table table-hover table-striped table-dark">
                    ...
                    <tbody>
                        <?php
                        $data = $this->getPaginationPayments();
                        ...
                        <?php else : ?>
                            <?php foreach ($data->getData() as $key => $value) : ?>
                                <tr id="txtData" class="<?php echo ($value->status == 1) ? "" : "table-danger"; ?>">
                                    ...
                                    <th><a href="<?php echo $this->getUrl()->getUrl('form', NULL, ['id' => $value->paymentId]); ?>"><i class="fa fa-pencil btn-info btn"></i></a></th>
                                    <th><a href="<?php echo $this->getUrl()->getUrl('delete', NULL, ['id' => $value->paymentId]); ?>"><i class="fa fa-trash btn-danger btn"></i></a></th>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
