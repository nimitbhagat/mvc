            ...
            <form action="<?php echo $this->getUrl()->getUrl('save'); ?>" method="post">
                ...
                <fieldset>
                    ...
                    <?php if (!$this->getRequest()->getGet('id')) { ?>
                        ...
                        <button class="btn btn-primary" type="submit" name="add">Add Configuration Group
                            <i class="fa fa-plus"></i>
                        </button>
                    <?php } else { ?>
                        <button class="btn btn-primary" type="submit" name="edit">Update Configuration Group
