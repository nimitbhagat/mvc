                    ...
                    <div class="panel-group checkout-steps" id="accordion">
                        ...
                        <div class="panel panel-default checkout-step-01">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <div class="row">
                                        <form action="<?php echo $this->getUrl()->getUrl('save', 'admin\cart'); ?>" method="post" id="form" class="register-form" role="form">
                        ...
                        <div class="panel panel-default checkout-step-02">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse ">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <form class="register-form" action="<?php echo $this->getUrl()->getUrl('save', 'admin\cart') ?>" role="form" method="post" id="form">
                                            <!-- already-registered-login -->
