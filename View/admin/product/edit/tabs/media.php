<div class="container">
    <div class="card text-left">
        <div class="card-body">
            ...
            <form action="<?php echo $this->getUrl()->getUrl('check', 'admin\media'); ?>" method="post" id="form">
                <?php if ($this->getRequest()->getGet('id')) { ?>
                    <fieldset>
                        ...
                        <div class="text-right">
                            <button class="btn btn-info" type="button" name="update" onclick="mage.resetParams().setForm('#form').load();">Update <i class="fa fa-pencil"></i></button>
                            <button class="btn btn-danger" type="button" name="delete" onclick="mage.resetParams().setForm('#form').load();">Delete <i class=" fa fa-trash"></i></button>
            ...
            <form method="post" id="form" action="<?php echo $this->getUrl()->getUrl('save', 'admin\media'); ?>" enctype="multipart/form-data">
                <div class="row">
