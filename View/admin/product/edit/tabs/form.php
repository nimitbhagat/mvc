            ...
            <form action="<?php echo $this->getUrl()->getUrl('save'); ?>" method="post" id="form">
                ...
                <fieldset>
                    ...
                    <?php if (!$this->getRequest()->getGet('id')) { ?>
                        ...
                        <button class="btn btn-primary" type="button" name="add" onclick="mage.resetParams().setForm('#form').load();">Add Product
                            <i class="fa fa-plus"></i>
                        </button>
                    <?php } else { ?>
                        <button class="btn btn-primary" type="button" name="edit" onclick="mage.resetParams().setForm('#form').load();">Update Product
