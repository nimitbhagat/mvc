<div class="container">
    <div class="card text-left">
        <div class="card-body">
            ...
            <form action="<?php echo $this->getUrl()->getUrl('save', 'Admin\Product\PriceGroup'); ?>" method="post" id="form">
                ...
                <fieldset>
                    ...
                    <div class="text-right">
                        <button class="btn btn-info m-1" type="button" onclick="mage.resetParams().setForm('#form').load();" name="update">Update <i class="fa fa-pencil"></i></button>
