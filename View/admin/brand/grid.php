        ...
        <div class="row">
            <?php foreach ($this->getButtons() as $key => $button) : ?>
                <div class="col-lg-8 col-md-7 col-sm-6">
                    <a onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('form', 'admin\brand', null, true); ?>').setMethod('post').load();" href="javascript:void(0);" class="btn btn-primary" name="update">Add Brand
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped ">
                        <thead>
                            ...
                            <tr>
                                <?php foreach ($this->getColumns() as $filterColumn) : ?>
                                    <td>
                                        <?php if ($filterColumn['type'] != "image") : ?>
                                            <div>
                        ...
                        <tbody>
                            ...
                            <?php if ($data == "") : ?>
                                <tr>
                                    <td colspan="<?php echo  count($this->getColumns()) + 1; ?>" style="text-align:center">
                                        <strong>
                                    ...
                                    <tr class="<?php echo ($value->status == 1) ? "" : "table-danger"; ?>">
                                        <?php foreach ($this->getColumns() as $column) : ?>
                                            <?php if ($column['type'] == 'image') : ?>
                                                <td>
                                                    <?php $idFolder = $this->getFieldValue($value, $column['field']); ?>
