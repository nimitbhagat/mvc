    ...
    <div class="page-header" id="banner">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7 col-sm-6">
                <a onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('form', 'admin\configurationGroup', null, true); ?>').setMethod('post').load();" href="javascript:void(0);" class="btn btn-primary" name="update">Add Configuration Group
