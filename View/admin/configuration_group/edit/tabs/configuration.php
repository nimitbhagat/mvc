<div class="container">
    <div class="card text-left">
        <div class="card-body">
            ...
            <form action="<?php echo $this->getUrl()->getUrl('save', 'Admin\ConfigurationGroup\Configuration'); ?>" method="post" id="form">
                            ...
                            <?php foreach ($configuration->getData() as $key => $value) : ?>
                                <div class="row col-md-12">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a class="btn btn-warning form-control" href="javascript:void(0)" onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('delete', 'admin\ConfigurationGroup\Configuration', ['configId' => $value->configId], false); ?>').load();"><i class="fa fa-trash"></i></a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
