        ...
        <div class="row">
            <?php foreach ($this->getButtons() as $key => $button) : ?>
                <div class="col-lg-8 col-md-7 col-sm-6">
                    <a onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('form', 'admin\attribute', null, true); ?>').setMethod('post').load();" href="javascript:void(0);" class="btn btn-primary" name="update">Add Attribute
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped  table-responsive">
                        ...
                        <tbody>
                            ...
                            <?php if ($data == "") : ?>
                                <tr>
                                    <td colspan="<?php echo count($this->getColumns()) ?>" style="text-align:center">
                                        <strong>
